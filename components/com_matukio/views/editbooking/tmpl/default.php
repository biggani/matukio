...
<fieldset class="adminform">
    ...
    <table class="mat_table">
        <tr>
            <td width="150" align="left" class="key">
                <?php echo JText::_('COM_MATUKIO_BOOKING_ID'); ?>:
            </td>
            <td>
                <?php if($this->booking->id != 0) {echo MatukioHelperUtilsBooking::getBookingId($this->booking->id) . " (" . $this->booking->id . ")"; }?>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?php  if($this->booking->id != 0) { echo $this->booking->bookingdate; } ?>
            </td>
        </tr>
