...
var Calendar = new Class({
	...
	loadCalEvents: function(){
		...
		for(var i = 0; i < this.options.cEvents.length; i++){
            ...
            // alert("timeformat: " + this.timeFormat + " | 12hour " + this.timeTwelveHourFormat);
            //alert(this.options.cEvents[i].start.toString());
            // alert(time);
	...
	extendDate: function(){ // this section could also be implemented with MooTools::Implement (no pun intended)
		...
		function thTime(timeFormat, timeTwelveHourFormat){
            ...
            if(timeTwelveHourFormat == true) {
                ...
                return this.format(timeFormat+ampm);
            } else {
//                alert(this.timeFormat);
                ...
                //alert(this.getUTCHours() + ":" + this.getMinutes());
